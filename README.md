...
The Dylos DC1100 Pro is [relatively affordable](http://www.dylosproducts.com/dcproairqumo.html) air quality sensor, has a serial data port, and [tracks well](http://www.aqmd.gov/docs/default-source/aq-spec/field-evaluations/dylos-dc1100---field-evaluation.pdf?sfvrsn=2) with the EPA-approved Grimm Model 180. Dylos units have a PC logging software, but it is prone to losing continuous data, can't track multiple units, has no alerting capabilities, and doesn't estimate mass concentration from particle counts.
